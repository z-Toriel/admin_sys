...
public class CodeGenerator {
    ...
    public static String scanner(String tip) {
        ...
        help.append("请输入Please input" + tip + "：");
    ...
    public static void main(String[] args) {
        ...
        gc.setServiceName("%sService"); //去掉Servicce接口的首字母I
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/vue_system?serverTimezone=GMT%2B8&characterEncoding=UTF-8");
...
//         String templatePath = "/templates/mapper.xml.vm";
        ...
        */
        ...
        strategy.setSuperEntityClass("com.system.common.BaseEntity");
        ...
        strategy.setControllerMappingHyphenStyle(true); // RequestMapping种的驼峰是否转成用"-"连接, 默认是false
